...
class JsonlAuditLogWriter(AuditLogWriter):
    ...
    def __init__(
        ...
        self._ensure_nwave_gitignore(resolved)

    @staticmethod
    def _ensure_nwave_gitignore(log_dir: Path) -> None:
        """Create .gitignore in the .nwave/ ancestor to prevent accidental commits."""
        # Walk up to find .nwave/ directory
        current = log_dir
